 ...
 */
final class Version20190507220512 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE exam (id INT AUTO_INCREMENT NOT NULL, quarter_id INT DEFAULT NULL, course_id INT DEFAULT NULL, section_id INT DEFAULT NULL, room_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, pass_at DATETIME NOT NULL, start_at DATETIME NOT NULL, finish_at DATETIME NOT NULL, coefficient INT NOT NULL, INDEX IDX_38BBA6C6BED4A2B2 (quarter_id), INDEX IDX_38BBA6C6591CC992 (course_id), INDEX IDX_38BBA6C6D823E37A (section_id), INDEX IDX_38BBA6C654177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE student_exam (id INT AUTO_INCREMENT NOT NULL, exam_id INT DEFAULT NULL, student_id INT DEFAULT NULL, note DOUBLE PRECISION NOT NULL, discipline TINYINT(1) NOT NULL, INDEX IDX_798DD1E578D5E91 (exam_id), INDEX IDX_798DD1ECB944F1A (student_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
