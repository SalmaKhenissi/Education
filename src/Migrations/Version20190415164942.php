 ...
 */
final class Version20190415164942 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE level_specialty (level_id INT NOT NULL, specialty_id INT NOT NULL, INDEX IDX_6638DD9D5FB14BA7 (level_id), INDEX IDX_6638DD9D9A353316 (specialty_id), PRIMARY KEY(level_id, specialty_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
